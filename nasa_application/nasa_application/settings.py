"""
Django settings for nasa_application project.
...
SECRET_KEY = 'django-insecure-^*+@4tw+59ai5(*m5dvmr#k*bxx^px=i(e@$as*uk!k5y#brc9'
...
ROOT_URLCONF = 'nasa_application.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],  # Se tiver um diretório global de templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
